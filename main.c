...
void Travel(Player* P1,Room ** World,int * cpt){
    ...
    do{
        ...
        printf("\033[33m\U00002502  Quelle direction?    \U00002502\033[0m\n"
               "\033[33m\U00002502\033[0m  Gauche : 1           \033[33m\U00002502\033[0m\n"
               "\033[33m\U00002502\033[0m  Droite : 2           \033[33m\U00002502\033[0m\n"
               "\033[33m\U00002502\033[0m  Bas : 3              \033[33m\U00002502\033[0m\n"
               "\033[33m\U00002502\033[0m  Haut : 4             \033[33m\U00002502\033[0m\n"
    ...
    switch(choice){
        case 1:
            ...
            else if (P1->room->Tab2D[P1->Position.y][P1->Position.x - 1] == '5'){}
        ...
        case 3:
            ...
            else if (P1->room->Tab2D[P1->Position.y+1][P1->Position.x] == '6'){}
